        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[const SizedBox(height: 80),
                  Image.asset('assets/images/onboard22.png', height: 230.h,),
                  const SizedBox(height: 45),
                  SizedBox(child: Text(
                      'We are here to help you',
                      style: TextStyle(color: const Color(0xFF1D2035), fontSize: 28.sp, fontWeight: FontWeight.w700,),),),
